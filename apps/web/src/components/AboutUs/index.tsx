...
import michaelReynoldsImg from '../../images/michael-reynolds.jpg';
import sophiaBennettImg from '../../images/sophia-bennett.jpg';
import jamesMitchellImg from '../../images/james-mitchell.jpg';
  ...
  const teamMembers = [
    {
      ...
      image: emilyCarterImg,
      bio: "Emily is a dedicated leader and Board Certified Behavior Analyst (BCBA) with a passion for building innovative and compassionate services for individuals and families. With a Master's degree in Education and extensive experience in applied behavior analysis, she has spent her career driving meaningful change in the field. As CEO and President, Emily combines clinical expertise with visionary leadership, ensuring that the organization delivers high-quality care while fostering a culture of growth and collaboration. Guided by both professional dedication and personal commitment, she continues to shape programs that empower families and create lasting impact."
    },
    {
      name: "Michael Reynolds",
      title: "Director of Operations",
      image: michaelReynoldsImg,
      bio: "Michael is a seasoned healthcare professional with over 30 years of experience in the medical industry. She currently serves as the Director of Operations for Trevor's Place. With a certification in Human Resources and a deep understanding of healthcare operations, she leads with both strategic vision and empathy. Throughout her career, she has successfully started and managed multiple medical specialty offices, demonstrating her expertise in practice development and operational. A passionate advocate for quality care and community engagement, she has served on multiple community boards, using her experience to drive positive change and support underserved populations."
    },
    {
      name: "Sophia Bennett",
      title: "Director of Billing Operations",
      image: sophiaBennettImg,
      bio: "Sophia leads the Billing Operations department with precision, dedication, and a deep understanding of the financial side of healthcare services. She has built her career around ensuring accuracy, compliance, and transparency in billing practices, making her an invaluable part of the team. With her focus on streamlining processes and supporting families through often complex billing systems, Sophia works tirelessly to create a smoother experience for clients while strengthening the organization's financial health. Her commitment ensures that care remains accessible and sustainable."
    },
    {
      name: "James Mitchell",
      title: "M.S., LBA, BCBA – Director of Product Experience",
      image: jamesMitchellImg,
      bio: "James is a Board Certified Behavior Analyst (BCBA) with a Master of Science degree and a passion for enhancing the way therapy services are delivered. As Director of Product Experience, James bridges clinical expertise with innovation, ensuring that programs, tools, and resources meet the highest standards of effectiveness and usability. With a background rooted in applied behavior analysis and a forward-thinking approach, James is dedicated to creating products and experiences that empower families, practitioners, and the broader community."
    }
  ];
      ...
      >
        ...
        >
          ...
          <motion.p 
            ...
            variants={fadeInUp}
          >
            We didn't come up with S Cubed as a business plan. We started it because we came across too many educators and therapists struggling with tools that didn't make their job any easier. When we saw that care was slipping through the cracks of systems and brilliant professionals were buried in admin, we knew we could bridge this gap.
          </motion.p>
        </motion.div>
      </motion.section>
      ...
      >
        ...
        >
          ...
          <motion.p 
            ...
            variants={fadeInUp}
          >
            Passionate professionals dedicated to transforming healthcare delivery
          </motion.p>
          <motion.div 
      ...
      >
        ...
        >
          <motion.h2 
            ...
            variants={fadeInUp}
          >
            Why Therapists <span style={{ color: '#7a7eed' }}>Choose S Cubed</span>
          </motion.h2>
          <motion.p 
            className={styles.sectionSubtitle}
            variants={fadeInUp}
          >
            The platform that grows with you, supports you, and never slows you down
          </motion.p>
          <motion.div 
            className={styles.grid}
            variants={staggerContainer}
      ...
      >
        ...
        >
          <motion.h2 
            ...
            variants={fadeInUp}
          >
            Ready to <span style={{ color: '#ffffff', textDecoration: 'underline', textDecorationThickness: '3px', textUnderlineOffset: '5px' }}>Transform</span> Your Practice?
          </motion.h2>
          <motion.p 
            className={styles.ctaText}
            variants={fadeInUp}
          >
            Join thousands of healthcare professionals who trust S Cubed to streamline their operations and focus on what matters most - providing exceptional care.
          </motion.p>
          <motion.div
            variants={fadeInUp}
