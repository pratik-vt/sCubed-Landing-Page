...
import { CreditCard, AlertCircle, ExternalLink, ChevronLeft } from 'lucide-react';
 ...
 */
export default function Step4PaymentProcessing({ formData, paymentUrl, onBack }: Step4Props) {
  ...
  const initializePayment = async () => {
    ...
    try {
      ...
      if (paymentUrl) {
        console.log('Using pre-generated payment URL from OTP verification:', paymentUrl);
      ...
      console.log('No pre-generated payment URL found. Creating new Stripe session...');
        ...
        <div className={`${styles.alertContainer} ${styles.alertInfo} ${styles.fadeInUpAnimation}`} style={{ animationDelay: '0.4s' }}>
          ...
          <div>
            ...
            <ul style={{ margin: '8px 0 0 0', paddingLeft: '20px' }}>
              ...
              <li>You'll be automatically redirected back to your success page</li>
