...
async function createSampleEvents(strapi) {
  ...
  try {
    ...
    const getFutureDate = (daysFromNow, hours = 9) => {
      const date = new Date();
    ...
    const getPastDate = (daysAgo, hours = 9) => {
      const date = new Date();
    ...
    const eventsData = [
      // Featured upcoming events
      {
        ...
        start_date: getFutureDate(60, 9),
        end_date: getFutureDate(62, 17),
      ...
      },
      {
        ...
        start_date: getFutureDate(15, 14),
        end_date: getFutureDate(15, 15.5),
      ...
      // More upcoming events
      {
        ...
        start_date: getFutureDate(30, 10),
        end_date: getFutureDate(30, 16),
      ...
      },
      {
        ...
        start_date: getFutureDate(45, 9),
        end_date: getFutureDate(45, 17),
      ...
      },
      {
        ...
        start_date: getFutureDate(75, 8),
        end_date: getFutureDate(76, 17),
      ...
      // Ongoing event (happening now)
      {
        ...
        start_date: getPastDate(2, 9),
        end_date: getFutureDate(3, 17),
        location: 'Online Event',
      ...
      // Past/Completed events
      {
        ...
        start_date: getPastDate(30, 9),
        end_date: getPastDate(28, 17),
      ...
      },
      {
        ...
        start_date: getPastDate(60, 10),
        end_date: getPastDate(45, 15),
        location: 'Online Event',
        registration_url: '',
        featured: false,
        categories: categories.slice(1, 2),
      ...
      // Additional upcoming events
      {
        ...
        start_date: getFutureDate(90, 9),
        end_date: getFutureDate(91, 17),
      ...
      },
      {
        ...
        start_date: getFutureDate(20, 13),
        end_date: getFutureDate(20, 17),
        location: 'Online Event',
      ...
      },
      {
        ...
        start_date: getFutureDate(35, 9),
        end_date: getFutureDate(35, 15),
      ...
      },
      {
        ...
        start_date: getFutureDate(55, 10),
        end_date: getFutureDate(55, 16),
