...
const TermsPage: React.FC<PageProps> = () => {
  return (
    <Layout>
      <h1 style={{ textAlign: 'center' }}>SCubed – Terms of Use</h1>
      ...
      <p>
        ...
        acknowledge that: (i) all Protected Materials are licensed and not sold;
        (ii) you acquire only the right to use the Protected Materials and we
        and our licensors shall retain sole and exclusive ownership of and all
        rights, title, and interest in the Protected Materials, (a) Intellectual
        Property embodied or associated with the Protected Materials, (b)
        deliverables and work product associated with the Protected Materials,
        and (c) all copies and derivative works thereof; and (iii) the Protected
        Materials, including the source and executable code, logic and
        structure, constitute valuable trade secrets of ours and our licensors.
        You agree to secure and protect the Protected Materials consistent with
        the maintenance of our and our licensors’ rights. You shall reimburse us
        for any and all expenses that we may incur (including interest,
        attorneys’ fees and other legal expenses) in connection with our efforts
        to enforce our rights against you with respect to the Protected
        Materials, or any of our Intellectual Property Rights in the event we
        prevail in such enforcement efforts.
      </p>
      <p>
        b) <strong>Restrictions.</strong> You shall not: <strong>(i)</strong>
        sell, resell, distribute, host, lease, rent, license or sublicense, in
        whole or in part, the Protected Materials; <strong>(ii)</strong> copy,
        decipher, decompile, disassemble, reverse assemble, modify, translate,
        reverse engineer or otherwise attempt to derive source code, algorithms,
        specifications, architecture, structure or other elements of the
        Protected Materials, in whole or in part, for competitive purposes or
        otherwise; <strong>(iii)</strong> allow access to, provide, divulge or
        make available the Protected Materials to any user other than those who
        have licenses to access; <strong>(iv)</strong> write or develop any
        derivative works based upon the Protected Materials;
        <strong>(v)</strong> modify, adapt, translate or otherwise make any
        changes to the Protected Materials or any part thereof;
        <strong>(vi)</strong> use the Protected Materials to provide processing
        services to third Parties, or otherwise use the same on a ‘service
        bureau’ basis; <strong>(vii)</strong> otherwise use or copy the
        Protected Materials except as expressly permitted herein; or
        <strong>(viii)</strong> remove from any Protected Materials
        identification, patent, copyright, trademark or other notices or
        circumvent or disable any security devices functionality or features.
        For the avoidance of doubt, you may copy or reproduce Protected
        Materials for the limited purpose of creating internal training
        materials for your internal use in connection with your use of the
        Software and Services, provided that such materials are destroyed upon
        the termination of the Agreement. You shall ensure that all users of the
        Protected Materials comply with the terms and conditions of the
        Agreement and shall promptly notify us of any actual or suspected
        violation. Further, you will cooperate with us with respect to
      ...
      <p>
        ...
        thereon is informed and believes that: (a) it has the full power and
        authority to enter into the Agreement and to perform its obligations
        hereunder, without the need for any consents, approvals or immunities
        not yet obtained; (b) its acceptance of and performance under the
        Agreement will not breach any oral or written agreement with any third
        party or any obligation owed by it to any third party to keep any
        information or materials in confidence or in trust; and (c) it complies
        with and will comply with any and all applicable local, state, and/or
        national laws or regulations applicable to such Party, including,
        without limitation, those related to PHI, Covered Entities, and Business
        Associates as each term is defined under HIPAA, and to any other laws or
      ...
      <p>
        ...
        Customer&#39;s written notice, (i) correct such error; (ii) provide you
        with a plan reasonably acceptable for correcting the error; or (iii) if
        neither (i) nor (ii) can be accomplished with commercially reasonable
        efforts from us, then we may, at our election terminate the Agreement.
      ...
      <p>
        ...
        <strong>
          WE RESERVE THE RIGHT TO MAKE CHANGES, CORRECTIONS, AND IMPROVEMENTS TO
          THE PROTECTED MATERIALS AT ANY TIME AND WITHOUT NOTICE.
        </strong>
      </p>
      <p>
      ...
      <p>
        ...
        third party services provider will have any (i) responsibility for
        determining the accuracy of any transaction, (ii) responsibility for
        settling disagreements or disputes between a payer and/or Customer, or
        (iii) any liability for the acts or omissions of a payer or you.
      </p>
      <p>
      ...
      <p>
        ...
        proceeding (a “Claim”) brought by a third party based on (i) the
        improper use or operation of the Software and Services (and any third
        party software provided to Customer pursuant to the Agreement), by you
        or your users, including, without limitation, any non-authorized use of
        your user logins, provided, however, that you shall have no
        indemnification obligation for any claim for which the proximate cause
        was our gross negligence or willful misconduct; (ii) a breach of the
        Agreement by you or any of your Users, (iii) the accuracy, quality,
        integrity, legality, reliability or appropriateness of Customer Data or
        any other content or data introduced to the Software and Services by any
        User; (iv) violation of any applicable law, rule or regulation by you or
        any of your Users, (v) the diagnosis and/or treatment of any of your
        patients or clients; and/or (vi) your negligent acts or willful
        misconduct, or that of your personnel. You will pay all Losses (whether
        by settlement or award after a final non-appealable judicial judgment)
        incurred by the Company Indemnified Parties from any such Claim.
      </p>
      <p>
        ...
        from or arising out of (i) the unauthorized disclosure by us of PHI in
        breach of the Business Associate Agreement; and (ii) a successful claim
        that the Software and Services infringes or misappropriates the patent,
        trade secret, trademark, copyright or other Intellectual Property Rights
        of any third party (an “Infringement Claim”). We will pay all Losses
        (whether by settlement or award of by a final judicial judgment)
        incurred by the Customer Indemnified Parties from any such Claim.
      </p>
      <h3>Termination</h3>
      <p>
      ...
      <p>Spectrum Software Solutions, LLC</p>
      <p>
        At &nbsp;
