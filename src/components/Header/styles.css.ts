...
export const textBlockStyle = style({
  ...
  textAlign: 'center',
  '@media': {
    'screen and (max-width: 768px)': { maxWidth: `90%`, width: `100%` },
  },
});
...
export const bannerImg = style({
  ...
  '@media': {
    ...
    'screen and (min-width: 700px) and (max-width: 760px)': { height: `150vh` },
    'screen and (max-width: 430px)': { height: `95vh` },
    'screen and (max-width: 414px)': { height: `100vh` },
    'screen and (max-width: 375px)': { height: `105vh` },
    'screen and (max-width: 360px)': { height: `110vh` },
    'screen and (max-width: 320px)': { height: `160vh` },
